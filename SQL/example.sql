...
INSERT INTO `ad_plan` (`user_id`, `plan_name`, `plan_status`, `start_date`, `end_date`, `create_time`, `update_time`) VALUES (10, '第二个推广计划', 1, '2018-01-01 00:00:00', '2019-12-01 00:00:00', '2018-01-01 00:00:00', '2018-01-01 00:00:00');
delete from ad_plan where id = 12;


-- 更新, 插入, 删除 ad_creative
update ad_creative set url = 'https://www.imooc.com';
INSERT INTO `ad_creative` (`name`, `type`, `material_type`, `height`, `width`, `size`, `duration`, `audit_status`, `user_id`, `url`, `create_time`, `update_time`) VALUES ('第二个创意', 1, 1, 720, 1080, 1024, 0, 1, 10, 'www.imooc.com', '2018-01-01 00:00:00', '2018-01-01 00:00:00');
